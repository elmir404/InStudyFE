$(document).ready(function () {
    ...
    $.ajax({
        ...
        url: `https://api.instudy.net/api/DirectionFront/GetDirectionFront?id=${linkValues[4]}`,
    ...
    $("#update").click(function () {
        ...
        $.ajax({
            type: "PUT",
            url: `https://api.instudy.net/api/DirectionFront/UpdateDirectionFront?id=${programId}`,
            data: formData,
