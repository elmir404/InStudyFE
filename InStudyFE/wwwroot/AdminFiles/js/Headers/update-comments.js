$(document).ready(function () {
    ...
    $.ajax({
        ...
        url: `https://api.instudy.net/api/StudentWordsFront/GetStudentWordsFront?id=${linkValues[4]}`,
    ...
    $("#update").click(function () {
        ...
        $.ajax({
            type: "PUT",
            url: `https://api.instudy.net/api/StudentWordsFront/UpdateStudentWordsFront?id=${programId}`,
            data: formData,
