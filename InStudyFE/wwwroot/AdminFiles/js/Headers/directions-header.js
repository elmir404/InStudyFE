$(document).ready(function () {
    ...
    $('#directionsheader-datatable').on('click', '.remove', function () {
        var table = $('#directionsheader-datatable').DataTable();
        var id = $(this).attr("id");
        var thh = $(this);
        debugger;
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "DELETE",
                    url: `https://api.instudy.net/api/DirectionFront/DeleteDirectionFront?id=${id}`,
