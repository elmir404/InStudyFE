$(document).ready(function () {
    ...
    $('#commentsheader-datatable').on('click', '.remove', function () {
        var table = $('#commentsheader-datatable').DataTable();
        var id = $(this).attr("id");
        var thh = $(this);
        debugger;
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "DELETE",
                    url: `https://api.instudy.net/api/StudentWordsFront/DeleteStudentWordsFront?id=${id}`,
