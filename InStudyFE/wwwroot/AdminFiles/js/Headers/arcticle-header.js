$(document).ready(function () {
    ...
    $('#arcticlesheader-datatable').on('click', '.remove', function () {
        var table = $('#arcticlesheader-datatable').DataTable();
        var id = $(this).attr("id");
        var thh = $(this);
        debugger;
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "DELETE",
                    url: `https://api.instudy.net/api/BlogFront/DeleteBlogFront?id=${id}`,
